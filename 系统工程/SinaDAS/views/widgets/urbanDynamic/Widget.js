...
define([
    ...
    function(declare,lang,parser,BaseWidget,on,query,dom,domConstruct,WidgetManager,topic,HorizontalSlider,
        HorizontalRuleLabels,Color,SimpleFillSymbol,SimpleLineSymbol,SimpleMarkerSymbol,LayerSwipe,ClassBreaksRenderer,domUtils, 
        FeatureSet, FeatureLayer, Geoprocessor, ImageParameters, QueryTask,Query,graphic,GraphicsLayer,
        SimpleRenderer) {
        return declare([BaseWidget], {
            ...
            startup: function() {
                ...
                this.ageTimeSlider = new HorizontalSlider({
                             ...
                             onChange: function(value){      
                                ...
                                case 4:
                                self.dycleanMap();
                                self.displayResult(GpAgeResultLayer4);
                                      break;
                                case 5:
                                self.dycleanMap();
            ...
            initLayout: function() {
                ...
                bindto:'#overallChart',
                    ...
                    data: {
                        columns: [
                            ['签到数据', 35957, 33779,  33995, 38173, 37936, 37359, 37603]
                        ]
                    },
                    axis: {
                        x: {
                            type:'category',
                            categories:['9/28','9/29','9/30','10/1','10/2','10/3','10/4']
                        }
                    }
                });
            ...
            calculateLayers:function(layerID,dateArrey){
                ...
                topic_calculateLayers=topic.subscribe("some/topic_calculateLayers_isDone", function(e){
                    ...
                    if(e[0]==="urbanHmd" && e[1]==='0'){
                        ...
                        dom.byId('stateBack').innerHTML = jobstatus;http://localhost:8002/
                    ...
                    var datechar=[];
                    datechar[0]= document.getElementById('UdataA').innerHTML; 
                    datechar[1]= document.getElementById('UdataB').innerHTML; 
                    datechar[2]= document.getElementById('UdataC').innerHTML; 
                    datechar[3]= document.getElementById('UdataD').innerHTML; 
                    datechar[4]= document.getElementById('UdataE').innerHTML; 
                    datechar[5]= document.getElementById('UdataF').innerHTML; 
                    datechar[6]= document.getElementById('UdataG').innerHTML; 
                    var numchar=['签到数据'];
                    numchar[1]= document.getElementById('UnumA').innerHTML; 
                    numchar[2]= document.getElementById('UnumB').innerHTML; 
                    numchar[3]= document.getElementById('UnumC').innerHTML; 
                    numchar[4]= document.getElementById('UnumD').innerHTML; 
                    numchar[5]= document.getElementById('UnumE').innerHTML; 
                    numchar[6]= document.getElementById('UnumF').innerHTML; 
                    numchar[7]= document.getElementById('UnumG').innerHTML; 
            ...
            startDoubleTime:function(){
                ...
                this.startGridGp("startDoubleTimeLayer",'2',StartDateStringB,StartTimeStringB,EndTimeStringB);
                   on(dojo.byId('twocompaer'),'click',function(){
                    ...
                    var features = GpGridResultLayer1.value.features;
                    ...
                    var featurestwo = GpGridResultLayer2.value.features;
                ...
                on(dojo.byId('cleanLayerSwipe'),'click',function(){      
                    ...
                    layerSwipe.destroy();  
                    layerSwipe = null;
                    // map.removeLayer(graphicone);
                    // map.removeLayer(graphictwo);
            ...
            startGenderAna :function(){
                ...
                this.startGenderGp("startGenderLayer",'2',StartDateStringM,StartTimeStringM,EndTimeStringM,'m');
                 ...
                 on(dojo.byId('SexcompaerLayer'),'click',function(){
                    ...
                    var renderer = new ClassBreaksRenderer(symbol, "checkin_nu");
                    renderer.addBreak(0, 1, new SimpleFillSymbol().setColor(new Color("#3FAB00")));
                    renderer.addBreak(1, 2, new SimpleFillSymbol().setColor(new Color("#BBE600")));
                    renderer.addBreak(2, 3, new SimpleFillSymbol().setColor(new Color("#D1ED00")));
                    renderer.addBreak(3, 5, new SimpleFillSymbol().setColor(new Color("#FFBF00")));
                    renderer.addBreak(5, Infinity, new SimpleFillSymbol().setColor(new Color("#FF0000")));
                    
                    var graphic = new GraphicsLayer();
                    var features = GenderResultLayer1.value.features;
                    for (var f = 0, fl = features.length; f < fl; f++) {
                        graphic.add(features[f]);
                    }
                    graphic.renderer = renderer;
                    self.map.addLayer(graphic);  
                    var graphictwo = new GraphicsLayer();
                    var featurestwo = GenderResultLayer2.value.features;
                    for (var f = 0, fl = featurestwo.length; f < fl; f++) {
                        graphictwo.add(featurestwo[f]);
                    }
                    graphictwo.renderer = renderer;
            ...
            startAgeTime:function(){
                ...
                var topic_startageTime = topic.subscribe("some/topic_startageTime_isDone",function(e){
                    if(e[0]==="startageLayer" && e[1]==='1'){
                        ...
                        dom.byId('stateBack').innerHTML = jobstatus;
                        dom.byId('resultLayer1').innerHTML = "11~16岁数据生成成功";
                        ...
                        dom.byId('stateBack').innerHTML = jobstatus;
                        dom.byId('resultLayer2').innerHTML = "17~23岁数据生成成功";
                            
                        map.addLayer(GpAgeResultLayer2);
                    }else if(e[0]==="startageLayer" && e[1]==='3'){
                        var jobstatus = "[任务]"+"ageGPLayer3"+":结果图层添加成功...";
                        dom.byId('stateBack').innerHTML = jobstatus;
                        dom.byId('resultLayer3').innerHTML = "24~33岁数据生成成功";
                            
                        map.addLayer(GpAgeResultLayer3);
                    }else if(e[0]==="startageLayer" && e[1]==='4'){
                        var jobstatus = "[任务]"+"ageGPLayer4"+":结果图层添加成功...";
                        dom.byId('stateBack').innerHTML = jobstatus;
                        dom.byId('resultLayer4').innerHTML = "34~45岁数据生成成功";
                            
                        map.addLayer(GpAgeResultLayer4);
                    }else if(e[0]==="startageLayer" && e[1]==='5'){
                        var jobstatus = "[任务]"+"ageGPLayer5"+":结果图层添加成功...";
                        dom.byId('stateBack').innerHTML = jobstatus;
                        dom.byId('resultLayer5').innerHTML = ">45岁数据生成成功";
                            
                        map.addLayer(GpAgeResultLayer5);
                    }
                     var numberchar1=['11 - 16 (岁)'];
                     var numberchar2=['17 - 23 (岁)'];
                     var numberchar3=['24 - 33 (岁)'];
                     var numberchar4=['34 - 45 (岁)'];
                     var numberchar5=['> 45(岁)'];
                    numberchar1[1]= document.getElementById('UagenumA').innerHTML; 
                    numberchar2[1]= document.getElementById('UagenumB').innerHTML; 
                    numberchar3[1]= document.getElementById('UagenumC').innerHTML; 
                    numberchar4[1]= document.getElementById('UagenumD').innerHTML; 
                    numberchar5[1]= document.getElementById('UagenumE').innerHTML; 
